<section class="l-sidebar">
  <p class="c-menu__tab js-menu__tab">依頼者向け</p>
  <ul class="c-menu--side js-menu__target">
    ...
    <li class="c-menu__item c-menu__item--side"><a href="{{ route('works.registered') }}" class="c-menu__link c-menu__link--side">登録した案件</a></li>
